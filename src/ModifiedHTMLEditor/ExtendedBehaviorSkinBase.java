 ...
 *
 */
public abstract class ExtendedBehaviorSkinBase<C extends Control, BB extends BehaviorBase<C>> extends SkinBase<C> {
    /**
     ...
     */
    protected ExtendedBehaviorSkinBase(final C control, final BB behavior) {
        super(control);

...
public class ExtendedHTMLEditorSkin extends ExtendedBehaviorSkinBase<ExtendedHTMLEditor, ExtendedHTMLEditorBehavior> {
...
//    private Button redoButton;
    ...
    public ExtendedHTMLEditorSkin(ExtendedHTMLEditor htmlEditor) {
        super(htmlEditor, new ExtendedHTMLEditorBehavior(htmlEditor));
...
//                }
    ...
    private void populateToolbars() {
        ...
        // Toolbar 1
        cutButton = addButton(toolbar1, "cutIcon", "cut", CUT_COMMAND, "html-editor-cut");
        copyButton = addButton(toolbar1, "copyIcon", "copy", COPY_COMMAND, "html-editor-copy");
        pasteButton = addButton(toolbar1, "pasteIcon", "paste", PASTE_COMMAND, "html-editor-paste");
...
//        toolbar1.getItems().add(new Separator());
        ...
        alignLeftButton = addToggleButton(toolbar1, alignmentToggleGroup,
                "alignLeftIcon", "alignLeft", ALIGN_LEFT_COMMAND, "html-editor-align-left");
        alignCenterButton = addToggleButton(toolbar1, alignmentToggleGroup,
                "alignCenterIcon", "alignCenter", ALIGN_CENTER_COMMAND, "html-editor-align-center");
        alignRightButton = addToggleButton(toolbar1, alignmentToggleGroup,
                "alignRightIcon", "alignRight", ALIGN_RIGHT_COMMAND, "html-editor-align-right");
        alignJustifyButton = addToggleButton(toolbar1, alignmentToggleGroup,
                "alignJustifyIcon", "alignJustify", ALIGN_JUSTIFY_COMMAND, "html-editor-align-justify");

        toolbar1.getItems().add(new Separator(Orientation.VERTICAL));

        outdentButton = addButton(toolbar1, "outdentIcon", "outdent", OUTDENT_COMMAND, "html-editor-outdent");
        if (outdentButton.getGraphic() != null) outdentButton.getGraphic().setNodeOrientation(NodeOrientation.INHERIT);
        indentButton = addButton(toolbar1, "indentIcon", "indent", INDENT_COMMAND, "html-editor-indent");
        ...
        bulletsButton = addToggleButton(toolbar1, listStyleToggleGroup,
                "bulletsIcon", "bullets", BULLETS_COMMAND, "html-editor-bullets");
        ...
        numbersButton = addToggleButton(toolbar1, listStyleToggleGroup,
                "numbersIcon", "numbers", NUMBERS_COMMAND, "html-editor-numbers");
        ...
        createFormatMenuItem(FORMAT_PARAGRAPH, "paragraph");
        Platform.runLater(() -> {
            formatComboBox.setValue("paragraph");
        });
        createFormatMenuItem(FORMAT_HEADING_1, "heading1");
        createFormatMenuItem(FORMAT_HEADING_2, "heading2");
        createFormatMenuItem(FORMAT_HEADING_3, "heading3");
        createFormatMenuItem(FORMAT_HEADING_4, "heading4");
        createFormatMenuItem(FORMAT_HEADING_5, "heading5");
        createFormatMenuItem(FORMAT_HEADING_6, "heading6");
...
//        });
        ...
        formatComboBox.setTooltip(new Tooltip("format"));
        ...
        fontFamilyComboBox.setTooltip(new Tooltip("fontFamily"));
        ...
        createFontSizeMenuItem(SIZE_XX_SMALL, "extraExtraSmall");
        createFontSizeMenuItem(SIZE_X_SMALL, "extraSmall");
        createFontSizeMenuItem(SIZE_SMALL, "small");
        Platform.runLater(() -> {
            fontSizeComboBox.setValue("small");
        });
        createFontSizeMenuItem(SIZE_MEDIUM, "medium");
        createFontSizeMenuItem(SIZE_LARGE, "large");
        createFontSizeMenuItem(SIZE_X_LARGE, "extraLarge");
        createFontSizeMenuItem(SIZE_XX_LARGE, "extraExtraLarge");
        fontSizeComboBox.setTooltip(new Tooltip("fontSize"));
        ...
        boldButton = addToggleButton(toolbar2, null,
                "boldIcon", "bold", BOLD_COMMAND, "html-editor-bold");
        ...
        italicButton = addToggleButton(toolbar2, null,
                "italicIcon", "italic", ITALIC_COMMAND, "html-editor-italic");
        underlineButton = addToggleButton(toolbar2, null,
                "underlineIcon", "underline", UNDERLINE_COMMAND, "html-editor-underline");
        strikethroughButton = addToggleButton(toolbar2, null,
                "strikethroughIcon", "strikethrough", STRIKETHROUGH_COMMAND, "html-editor-strike");

        toolbar2.getItems().add(new Separator(Orientation.VERTICAL));

        insertHorizontalRuleButton = addButton(toolbar2, "insertHorizontalRuleIcon",
                "insertHorizontalRule", INSERT_HORIZONTAL_RULE_COMMAND, "html-editor-hr");
...
///        String fgIcon = AccessController.doPrivileged((PrivilegedAction<String>) () -> ExtendedHTMLEditorSkin.class.getResource("foregroundColorIcon").toString());
  //      ((StyleableProperty)fgColorPickerSkin.imageUrlProperty()).applyStyle(null,fgIcon);

        fgColorButton.setValue(DEFAULT_FG_COLOR);
        fgColorButton.setTooltip(new Tooltip("foregroundColor"));
...
//        Image icon = AccessController.doPrivileged((PrivilegedAction<Image>) () -> new Image(ExtendedHTMLEditorSkin.class.getResource(iconName).toString()));
